...
public class OpCTLXnor extends AbstractBinaryOperator implements ICTLOperator {

	public OpCTLXnor(AbstractElement a_left, AbstractElement a_right)
	...
	@Override
	protected OpCTLXnor duplicate() throws SMVParseException {
		return new OpCTLXnor(this.getLeft(), this.getRight());
	}
