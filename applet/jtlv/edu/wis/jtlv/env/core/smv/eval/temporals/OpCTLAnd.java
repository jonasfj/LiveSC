...
public class OpCTLAnd extends AbstractBinaryOperator implements ICTLOperator {

	public OpCTLAnd(AbstractElement a_left, AbstractElement a_right)
	...
	@Override
	protected OpCTLAnd duplicate() throws SMVParseException {
		return new OpCTLAnd(this.getLeft(), this.getRight());
	}
