...
public class OpLTLSince extends AbstractBinaryOperator implements ILTLOperator {

	public OpLTLSince(AbstractElement a_left, AbstractElement a_right)
	...
	@Override
	protected OpLTLSince duplicate() throws SMVParseException {
		return new OpLTLSince(this.getLeft(), this.getRight());
	}
