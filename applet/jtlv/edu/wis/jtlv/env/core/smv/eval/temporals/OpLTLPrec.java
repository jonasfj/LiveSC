...
public class OpLTLPrec extends AbstractUnaryOperator implements ILTLOperator {

	public OpLTLPrec(AbstractElement a_val) throws SMVParseException {
		super(a_val);
	}
	...
	@Override
	protected OpLTLPrec duplicate() throws SMVParseException {
		return new OpLTLPrec(this.getVal());
	}
