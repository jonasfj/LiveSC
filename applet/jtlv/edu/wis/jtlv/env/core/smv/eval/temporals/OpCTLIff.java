...
public class OpCTLIff extends AbstractBinaryOperator implements ICTLOperator {

	public OpCTLIff(AbstractElement a_left, AbstractElement a_right)
	...
	@Override
	protected OpCTLIff duplicate() throws SMVParseException {
		return new OpCTLIff(this.getLeft(), this.getRight());
	}
