 ...
 * 
 */
public class JTLVJddFactory extends BDDFactoryIntImpl {


    public static final String REVISION = "$Revision: 1.3 $";
    
    public String getVersion() {
        return "JTLVJddFactory "+REVISION.substring(11, REVISION.length()-2);
    }
    ...
    private JTLVJddFactory(int nodenum, int cachesize) {
        initialize(nodenum, cachesize);
    }
    
	private JTLVJddFactory() {
	}
    ...
    public static BDDFactory init(int nodenum, int cachesize) {
        BDDFactory f = new JTLVJddFactory(nodenum, cachesize);
        return f;
    }
