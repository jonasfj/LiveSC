...
(function() {
  var Example, Examples, _ref;

  if ((_ref = this.LSC) == null) {
    this.LSC = {};
  }

  this.LSC.Examples = Examples = [];

  Example = function(e) {
    return Examples.push(e);
  };

  LSC.loadExample = function(callback) {
    var close, div, ex, topdiv, _i, _len, _ref1;
    $("#examples").html("");
    topdiv = $("<div class=\"topdiv\"></div>");
    $("<h1>Pick an Example</h1>").appendTo(topdiv);
    close = $("<span style=\"float:right;\">(Close)</span>");
    close.click(function() {
      return $("#examples").fadeOut(cfg.animation.speed);
    });
    ...
    return $("#examples").fadeIn(cfg.animation.speed);
  };
          ...
          "messages": [
            {
              ...
              "name": "displayCallerID",
              "location": 4,
              "source": "Chip",
              "target": "Display"
            }, {
              "name": "setDisplayCaller",
              "location": 5,
              "source": "Display",
              "target": "Display"
            }
